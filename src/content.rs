...
pub async fn compute_content_hash_async(path: &Path) -> std::io::Result<String> {
...
#[tokio::test]
async fn test_compute_file_async() {
    assert_eq!(
        Some("22fab83a2b47a54531588ea2b025e8c48f5e03b40df4283f0ec1c70b0faba38e".to_owned()),
        compute_content_hash_async(Path::new("testdata/rawdata/file1.txt")).await.ok()
    );
}